            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 relative">
                    ...
                    <div className="flex items-center space-x-8">
                        ...
                        {/* Desktop Menu */}
                        <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center space-x-6 whitespace-nowrap">
                            {menuItems.map((item) => (
                                <button
                                    key={item.id}
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="relative group">
                            ...
                            {/* Dropdown Menu */}
                            <div className="hidden group-hover:block group-focus-within:block absolute right-0 top-full pt-2 w-48 z-50">
